...
- Each distribution is stored in a separate file under `pkg/app/dist/`
...
- Lognormal (`pkg/app/dist/lognormal.R`)
- Normal (`pkg/app/dist/normal.R`)
- Weibull (`pkg/app/dist/weibull.R`)
- Pareto (`pkg/app/dist/pareto.R`)
- GB2 (`pkg/app/dist/gb2.R`)
- dPLN (`pkg/app/dist/dpln.R`)
- Mixture (`pkg/app/mixture.R`)
