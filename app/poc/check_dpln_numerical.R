...
pdf_integrand <- function(x) dpln_4p_pdf(x, fit)
...
mean_integrand <- function(x) x * dpln_4p_pdf(x, fit)
...
numerical_mean2 <- integrate(function(x) x * dpln_4p_pdf(x, fit2), lower = 0, upper = Inf)$value
